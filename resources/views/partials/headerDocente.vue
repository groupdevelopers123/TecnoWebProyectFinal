...
const nombreCompleto = computed(() => {
    ...
    return usuario.value.name ?? "Usuario";
});

const correoDocente = computed(() => {
...
const carrerasActivas = computed(() => {
    return page.url.startsWith("/docente/carreras");
});
...
const inicioUrl = computed(() => route("docente.home"));
...
const seleccionarSeccion = (seccion, nombreVisible) => {
    ...
    if (seccion === "mis-carreras") {
        irACarreras();
        return;
    }

    if (seccion === "mis-materias") {
        irAMaterias();
        return;
    }
        ...
        >
            ...
            >
                <Link
                    ...
                    :class="
                        page.url.startsWith('/docente/inicio')
