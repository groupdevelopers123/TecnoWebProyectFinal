<template>
    <Head title="Detalle de Concepto de Pago" />
    ...
    <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        >
            <div class="flex items-center gap-4">
                <div
                    class="flex h-16 w-16 items-center justify-center rounded-3xl bg-amber-100 text-2xl text-amber-700"
                >
            ...
            <div class="flex gap-3">
                <Link
                    :href="route('admin.concepto-pagos.edit', concepto.id)"
                ...
                <Link
                    :href="route('admin.concepto-pagos.index')"
