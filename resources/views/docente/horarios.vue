        ...
        <main class="px-5 pb-20 pt-24 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-7xl">
                    ...
                    >
                        <div class="max-w-3xl">
                            ...
                            <p class="mt-3 text-lg text-slate-500">
                                Consulta tus clases agrupadas por materia, con
                                días, horas y aula.
                            </p>
                        </div>
                        <div
                ...
                <div v-if="tieneHorarios" class="grid gap-6 lg:grid-cols-2">
                    <template
                        v-for="(materia, index) in horarios"
                ...
                >
                    ...
                    <p class="mt-2 text-sm text-slate-500">
                        No hay horarios registrados para tu perfil. Contacta al
                        administrador para revisar tus asignaciones.
                    </p>
                </div>
            </div>
        </main>
